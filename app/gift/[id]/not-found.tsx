/**
 * Not-found scoped alla route /gift/[id]. Sovrascrive il
 * fallback globale con copy specifica per quando il gift non
 * esiste (ID sbagliato, gift cancellato dal mittente, ecc).
 */
